...
(function (global, factory) {
		if (typeof define === "function" && define.amd) {
				define(['./loadAudio'], factory);
		} else if (typeof exports !== "undefined") {
				factory(require('./loadAudio'));
		} else {
				var mod = {
						exports: {}
				};
				factory(global.loadAudio);
				global.main = mod.exports;
		}
})(undefined, function (_loadAudio) {
		'use strict';
		...
		var _loop = function _loop(i) {
				(0, _loadAudio.loadAudio)('media/C' + i + '.wav').then(function (response) {
